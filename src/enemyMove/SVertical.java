...
import renderer.Renderer.Forward;

public class SVertical implements IEnemyAI
{
    ...
    {
        if((self.MoveSig() == Enemy.MoveSig.GO || self.MoveSig() == Enemy.MoveSig.BACK
                ) && this.forward == Forward.UP)
        {
            self.addVelY(-SPEED);
        }
        else if((self.MoveSig() == Enemy.MoveSig.GO || self.MoveSig() == Enemy.MoveSig.BACK
                ) && this.forward == Forward.DOWN)
        {
            self.addVelY(SPEED);
        }
        if(!isActiveY(self))
        ...
        else if(self.MoveSig() == Enemy.MoveSig.BACK && backHabit(self))
        {
